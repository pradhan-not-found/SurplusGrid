  ...
  return (
    <div className="min-h-screen bg-[#f9fafb] flex font-sans selection:bg-green-500 selection:text-white">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 sm:px-12 lg:px-24">
        <div className="w-full max-w-md mx-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
            ...
            <p className="text-gray-500 mb-8 font-light">Sign in to your account to continue.</p>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <button 
                type="submit"
                className="w-full py-3.5 px-4 bg-[#1a1a1a] hover:bg-black text-white rounded-xl text-sm font-medium transition-all shadow-md hover:shadow-lg mt-4"
              >
                Sign In
              </button>
            </form>
      ...
      <div className="hidden lg:block lg:w-1/2 relative bg-[#1e362d] overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#223B2F] to-[#152720] opacity-90"></div>
        <img 
          src="/image.png" 
          alt="Clean Energy" 
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-12 lg:p-20">
          <h3 className="text-3xl font-light text-white mb-4 leading-tight">
            Optimizing the grid of <br/>tomorrow, today.
          </h3>
          <p className="text-green-100/80 max-w-md font-light leading-relaxed">
            Join hundreds of renewable producers and industrial consumers making the energy transition profitable.
          </p>
        </div>
      </div>
    </div>
